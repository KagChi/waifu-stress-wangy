...
const CTASection = () => {
  ...
  function userOption(name: string, option: string) {
    ...
    if (option === "stress") {
      return `GW BENAR-BENAR PENGEN JILATI KAKI ${name}. GW PENGEN BANGET MENJILAT SETIAP 
             BAGIAN KAKINYA SAMPAI AIR LIUR GW BERCUCURAN KAYAK AIR KERINGAT LALU NGENTOD DENGAN NYA
             SETIAP HARI SAMPAI TUBUH KITA MATI RASA YA TÜHAN. GW INGIN MEMBUAT ANAK-ANAK 
             DENGAN ${name} SEBANYAK SATU TÌM SEPAK BOLA DAN MEMBUAT SATU TIM SEPAK BOLA LAINNYA UNTUK MELAWAN 
             ANAK-ANAK TIM SEPAK BOLA PERTAMA GW YANG GW BUAT SAMA ${name}. GW PENGEN MASUK KE SETIAP LUBANG TUBUHNYA, 
